        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="breadcaump-inner text-center">
              <h1 class="heading heading-h1">FAM Trips</h1>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  watch: {
    '$route'() {
      ...
      pageTrackGAV4(this.$gtag, window.location.pathname, `FAM Trips | ${pageTitle}`, window.location.href);
      screenViewGAV4(this.$gtag, `FAM Trips | ${pageTitle}`, siteUid);
