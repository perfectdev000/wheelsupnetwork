<template>
  <div>
    <div class="breadcaump-area py-2 mb--30 bg_color--1 breadcaump-title-bar">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="breadcaump-inner text-center">
              <h1 class="heading heading-h1"> {{ $t('upcomingevent')}} </h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="container">
            <div class="row mtn--50">
              <div
                ...
                <BlogPostThree
                  :category-slug="localePath({ name: 'proximos-eventos'})"
                  :article="article"
                  add-class="blog-standard blog-grid--modern" read-more-button/>
              </div>
            </div>
...
export default {
  ...
  watch: {
    '$route'() {
      ...
      pageTrackGAV4(this.$gtag, window.location.pathname, `${this.$t("upcomingevent")} | ${pageTitle}`, window.location.href);
      screenViewGAV4(this.$gtag, `${this.$t("upcomingevent")} | ${pageTitle}`, siteUid);
  ...
  head() {
    ...
    return {
      title: `${this.$t('upcomingevent')}  | ${ siteName }`,
      link: [
        {
          rel: "shortcut icon",
          type: "image/x-icon",
