          ...
          <div class="portfolio-left bk-portfolio-details">
            <div class="portfolio-main-info">
              <div class="bk-quote-content">
                <blockquote class="brook-quote wow">
                  <CustomerLogo
                    :customer="article.customer"
                    :addClass="`customer-logo-medium`"
                  />
                  <div class="quote-text">
                    <h5 class="heading heading-h5 line-height-1-42 text-muted">
                      {{ article.description }}
                    </h5>
                  </div>
                </blockquote>
              ...
              <div class="portfolio-content text-justify mt--40">
                <!-- <h6 class="heading heading-h6">{{ article.description }}</h6> -->
...
export default {
  ...
  async asyncData({ $strapi, params, query, $config: { siteUid } }) {
    const matchingArticle = await $strapi.find("promotions", {
      slug: params.slug,
      "sites.uid": siteUid,
    });
    return {
