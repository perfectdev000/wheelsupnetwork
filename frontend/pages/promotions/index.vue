<template>
  <div>
    <div class="breadcaump-area py-2 mb--10 bg_color--1 breadcaump-title-bar">
      <div class="container">
        <div class="row mb--30">
          <div class="col-lg-12">
            <div class="breadcaump-inner text-center">
              <h1 class="heading heading-h1">{{ $t("title_promotions") }}</h1>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  watch: {
    '$route'() {
      ...
      pageTrackGAV4(this.$gtag, window.location.pathname, `${this.$t("title_promotions")} | ${pageTitle}`, window.location.href);
      screenViewGAV4(this.$gtag, `${this.$t("title_promotions")} | ${pageTitle}`, siteUid);
  ...
  head() {
    ...
    return {
      title: ` ${this.$t("title_promotions")} | ${siteName}`,
      link: [
        {
          rel: "shortcut icon",
          type: "image/x-icon",
