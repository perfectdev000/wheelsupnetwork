        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="breadcaump-inner text-center">
              <h1 class="heading heading-h1">{{ $t("new") }}</h1>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  watch: {
    '$route'() {
      ...
      pageTrackGAV4(this.$gtag, window.location.pathname, `${this.$t("new")} | ${pageTitle}`, window.location.href);
      screenViewGAV4(this.$gtag, `${this.$t("new")} | ${pageTitle}`, siteUid);
